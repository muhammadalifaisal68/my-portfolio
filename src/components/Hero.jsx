  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-24 relative overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.7 }}
          ...
          {[
            ...
            <motion.a key={i} href={btn.href}
              ...
              whileTap={{ scale: 0.95 }}
              className={`px-8 py-3 rounded-full transition font-medium ${btn.primary
                ? 'bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-500/30'
                : darkMode
                  ? 'border border-blue-600 hover:bg-blue-600/20 text-white'
                  : 'border border-blue-600 hover:bg-blue-600/20 text-gray-900'}`}>
              {btn.label}
            </motion.a>
          ))}
        </motion.div>
      ...
      <motion.div
        ...
        <div className={`w-6 h-10 border-2 ${darkMode ? 'border-gray-600' : 'border-gray-300'} rounded-full flex justify-center pt-2`}>
