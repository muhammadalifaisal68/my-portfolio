  ...
  return (
    <section id="contact" className="py-20 px-6 max-w-5xl mx-auto" ref={ref}>
      <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}
        ...
        <p className={`mt-4 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>Feel free to reach out for internship or job opportunities.</p>
      </motion.div>
      ...
      <div className="grid md:grid-cols-2 gap-12">
        <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.2, duration: 0.6 }}
          ...
          <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} leading-relaxed`}>
            I'm currently looking for new opportunities. Whether you have a question, a project in mind, or just want to say hi — my inbox is always open!
          </p>
            ...
            {[
              ...
              <motion.div key={i} whileHover={{ x: 6 }} className="flex items-center gap-4">
                ...
                <div>
                  ...
                  {item.href ? <a href={item.href} className="text-blue-400 hover:underline">{item.value}</a>
        ...
        <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ delay: 0.3, duration: 0.6 }}
          ...
          {submitted ? (
            <motion.div initial={{ scale: 0.8, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-center py-12">
              ...
              <p className={`${darkMode ? 'text-gray-400' : 'text-gray-600'} text-sm mb-6`}>Thanks for reaching out! I'll get back to you soon. 📧</p>
            ...
            <div className="space-y-4">
              ...
              {[
                ...
                <div key={i}>
                  ...
                  <input type={field.type} value={formData[field.key]}
                    ...
                    className={`w-full ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-300 text-gray-900'} border rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition`}
              ...
              <div>
                ...
                <textarea value={formData.message} onChange={e => setFormData({...formData, message: e.target.value})}
                  className={`w-full ${darkMode ? 'bg-gray-800 border-gray-700 text-white placeholder-gray-500' : 'bg-gray-50 border-gray-300 text-gray-900'} border rounded-xl px-4 py-3 focus:outline-none focus:border-blue-500 transition resize-none`}
